defmodule PageTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PageTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PageTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
